  ...
  return (
    <footer className="relative">
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <AgamLogomark size={20} className="text-emerald-400" />
              <p className="font-bold text-emerald-400">Agam Labs</p>
            </div>
            <p className="mt-1 text-sm text-white/50 dark:text-white/50 [html:not(.dark)_&]:text-black/40">
          ...
          {/* Products */}
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-wider text-white/60 dark:text-white/60 [html:not(.dark)_&]:text-black/50">
              Products
            </p>
        ...
        <p className="mt-6 text-center text-sm text-white/40 dark:text-white/40 [html:not(.dark)_&]:text-black/30">
